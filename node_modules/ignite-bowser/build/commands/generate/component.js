...
exports.description = "Generates a component and a storybook test.";
exports.run = async function (toolbox) {
    // grab some features
    ...
    if (!filesystem.exists(barrelExportPath)) {
        const msg = `No '${barrelExportPath}' file found. Can't export component.` +
    ...
    // wire up example
    await patching.prepend("./storybook/storybook-registry.ts", `require("../app/components/${kebabCaseName}/${kebabCaseName}.story")\n`);
};
